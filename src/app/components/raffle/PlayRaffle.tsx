...
export function PlayRaffle() {
  ...
  const { data, isLoading, isSuccess, write } = useContractWrite({
    ...
    abi,
    functionName: "playRaffle",
  });
  return (
    <>
      <div className={"space-y-5 mt-3"}>
        <div className={"space-x-5"}>
          <label className={""}>Input token address for deposit</label>
          <input
        ...
        <button
          ...
          onClick={() => {
            write({
              args: [targetTokenAddress, parseEther(amount.toString(), "wei")],
            });
